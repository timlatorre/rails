...
s2 = Studio.create(:name => "Wanrer Bros", :budget => 5, :address => "Hollywood")
s3 = Studio.create(:name => "Paramount", :budget => 7, :address => "Hollywood")
s4 = Studio.create(:name => "Sony Pictures", :budget => 7, :address => "Hollywood")
